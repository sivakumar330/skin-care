...
if (imageInput && uploadArea && previewContainer && resultsSection) {
  ...
  function simulateAnalysis(file) {
    ...
    setTimeout(() => {
      ...
      if (confidenceFill)
        confidenceFill.style.width = `${randomDisease.confidence}%`;
      if (confidenceText)
        confidenceText.textContent = `Confidence: ${randomDisease.confidence}%`;
  ...
  if (saveReportBtn) {
    saveReportBtn.addEventListener("click", () => {
      const primaryCondition =
        document.getElementById("primaryCondition").textContent;
...
const diseasesData = [
  {
    ...
    image: "img/1.jpg",
    description:
      "Inflammatory skin condition with comedones, papules, and pustules.",
  ...
  },
  {
    ...
    image: "img/4.jpg",
    description:
      "Most dangerous form of skin cancer caused by uncontrolled melanocyte growth.",
  ...
  },
  {
    ...
    image: "img/5.jpg",
    description:
      "Chronic facial skin disorder causing redness and visible blood vessels.",
  ...
  },
  {
    ...
    image: "img/6.webp",
    description:
      "Allergic or irritant reaction causing itchy, red rashes on skin.",
  ...
  },
  {
    ...
    image: "img/7.webp",
    description:
      "Autoimmune condition leading to sudden hair loss in round patches.",
...
function renderDiseases() {
  ...
  const filteredDiseases = diseasesData.filter((disease) => {
    const matchesCategory =
      currentCategory === "all" || disease.category === currentCategory;
    const matchesSearch =
  ...
  diseasesGrid.innerHTML = diseasesToShow
    .map(
      (disease) => `
  <div class="disease-card animate-on-scroll">
    ...
    <div class="disease-content">
      ...
      <div class="disease-tags">
        ${disease.tags
          .map((tag) => `<span class="disease-tag">${tag}</span>`)
          .join("")}
...
`
  ...
  if (loadMoreBtn) {
    loadMoreBtn.style.display =
      displayedCount >= filteredDiseases.length ? "none" : "block";
  }
